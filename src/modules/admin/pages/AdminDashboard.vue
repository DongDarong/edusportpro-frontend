  ...
  <MainLayout>
    ...
    <section class="dashboard">
      <div v-if="loading" class="dashboard__state">
        <LoadingSpinner label="Loading dashboard" size="md" />
      </div>
      ...
      <template v-else>
        ...
        <article class="dashboard__panel">
          <header class="dashboard__panel-head">
            ...
            <StatusBadge status="info" label="Live Feed" :dot="true" size="sm" />
          </header>

          <ul class="dashboard__activity">
            <li v-for="item in recentActivities" :key="item.id" class="dashboard__activity-item">
              <div>
                <p class="dashboard__activity-message">{{ item.message }}</p>
